...
import { Star, Bike, MapPin, Eye } from "lucide-react";
...
export function FleetTable({ rows, onView }: { rows: FleetRider[]; onView?: (r: FleetRider) => void }) {
  return (
    <div
        ...
        <table className="w-full text-sm">
          <thead>
            <tr style={{ backgroundColor: "#fbf9f5" }}>
              {["Livreur", "Véhicule", "Zone", "Statut", "Niveau", "Note", "Courses", "Gains", "Inscrit", ""].map((h) => (
                <th
                  key={h}
